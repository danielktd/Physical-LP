! function(e) {
    ...
    e.Navbar = {
        ...
        e.Navbar.init(), e.Addons.swiperCarousel(".swiper-init"), e.Addons.typed(".type-init"), e.Addons.glightbox(), e.Custom.submitForm(".form-submit-init"), e.Custom.priceToggle(".pricing-toggle"), e.Custom.showHidePassword(".password-toggle"), e.Custom.darkmode(".dark-mode-toggle"), e.Dropdown.header("." + t.classes.toggle), e.CurrentLink("." + t.classes.link, t.classes.item, t.classes.sub, t.classes.main, [t.classes.active, t.classes.current], !0)
    }, e.BS.init = function() {
